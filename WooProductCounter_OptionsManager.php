...
class WooProductCounter_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'woo-product-counter'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'woo-product-counter'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'woo-product-counter'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'woo-product-counter'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'woo-product-counter');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'woo-product-counter'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'woo-product-counter');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'woo-product-counter'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <table class="plugin-options-table"><tbody>
                            <tr valign="top">
                                <th scope="row"><p><label>Shortcode</label></p></th>
                                <td>[woopcounter]
								</td>
                            </tr>
                            <tr valign="top">
                                <th scope="row"><p><label>Widget</label></p></th>
                                <td>You can also use the widget.<td>
                            </tr>							
                            <tr valign="top">
                                <th scope="row"><p><label>Required*</label></p></th>
                                <td>WooCommerce <a href="http://www.woothemes.com/woocommerce/">Get Woocommerce</a><td>
                            </tr>
                            <tr valign="top">
                                <th scope="row"><p><label>Author</label></p></th>
                                <td>Johnny Dunhin<td>
                            </tr>		
                            <tr valign="top">
                                <th scope="row"><p><label>Email</label></p></th>
                                <td>For support you can email me, but I do not give dedicated support. <a href="mailto:johnny@trouidees.co.za?Subject=WoopCounter Support" target="_top">Send Mail </a><td>
                            </tr>					
                </tbody></table>
            </form>
        </div>
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'woo-product-counter');
            case 'false':
                return __('false', 'woo-product-counter');

            case 'Administrator':
                return __('Administrator', 'woo-product-counter');
            case 'Editor':
                return __('Editor', 'woo-product-counter');
            case 'Author':
                return __('Author', 'woo-product-counter');
            case 'Contributor':
                return __('Contributor', 'woo-product-counter');
            case 'Subscriber':
                return __('Subscriber', 'woo-product-counter');
            case 'Anyone':
                return __('Anyone', 'woo-product-counter');
        }
        return $optionValue;
    }
